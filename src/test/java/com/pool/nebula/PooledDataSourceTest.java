...
public class PooledDataSourceTest {
    ...
    public void simpleTest() throws Exception {
        ...
        dataSourceConfig.setJdbcUrl("jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf-8");
        ...
        // 初始化
        source.init();
        NebulaPooledConnection connection = source.getConnection();
        ...
        NebulaPooledConnection connection2 = source.getConnection();
    ...
    public void notWaitTest() throws Exception {
        ...
        PooledDataSourceConfig dataSourceConfig = new PooledDataSourceConfig();
        dataSourceConfig.setDriverClass("com.mysql.cj.jdbc.Driver");
        dataSourceConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&characterEncoding=utf-8");
        dataSourceConfig.setUser("root");
        dataSourceConfig.setPassword("test123456");
        dataSourceConfig.setMinSize(1);
        dataSourceConfig.setMaxSize(1);
